...
"audio" : {"timestamps" : (scriptedvided.nextTS(configs), "01:50.9" ), "padAudio" : 0.1 },\
 "overlay" : { \
    "text" : ["'Fallout 4'",\
              ...
              scriptedvided.r6sText('1920x1080, high settings', 29, 27),\
              scriptedvided.r6sText('1600x900, high settings' , 37, 33),\
    ]\
}, \
})
...
"overlay" : { \
    "text" : ["'Apex Legends'",\
              scriptedvided.r6sText('1920x1080, low settings', 66, 45),\
              scriptedvided.r6sText('1600x900, low settings' , 82, 56),\
              scriptedvided.r6sText('1280x720, low settings' , 104, 72),\
    ]\
}, \
})
...
"overlay" : { \
    "text" : ["'Shadow of the Tomb Raider'",\
              ...
              scriptedvided.r6sText('1600x900, lowest settings' , 53, 37),\
              scriptedvided.r6sText('1280x720, lowest settings' , 68, 39),\
    ]\
}, \
})
...
"overlay" : { \
    "text" : ["'Counter-Strike 2'",\
              scriptedvided.r6sText('1920x1080, low settings', 80, 66),\
              scriptedvided.r6sText('1600x900, low settings' , 107, 82),\
              scriptedvided.r6sText('1280x720, low settings' , 119, 71),\
]}, \
})
...
"overlay" : { \
    "text" : ["'Fortnite'",\
              scriptedvided.r6sText('1920x1080, performance mode', 75 , 24 ),\
              scriptedvided.r6sText('1600x900, performance mode' ,  99, 67 ),\
              scriptedvided.r6sText('1280x720, performance mode' ,  132, 65),\
]}, \
})
...
"overlay" : { \
    "text" : ["'Fortnite Reload'",\
              scriptedvided.r6sText('1920x1080, performance mode', 175, 117),\
              scriptedvided.r6sText('1600x900, performance mode' , 218, 142),\
              scriptedvided.r6sText('1280x720, performance mode' , 237, 158),\
]}, \
})
...
"overlay" : { \
    "text" : ["'Terminator\: Resistance'",\
              ...
              scriptedvided.r6sText('1280x720, low settings' ,  91,  69),\
]}, \
})
...
"overlay" : { \
    "text" : ["'Overwatch 2'",\
              scriptedvided.r6sText('1920x1080, low settings', 87,  66),\
              scriptedvided.r6sText('1600x900, low settings' , 123, 94 ),\
              scriptedvided.r6sText('1280x720, low settings' , 179,  141),\
]}, \
})
...
"video" : {"file" : "ZenlessZoneZero_2024_07_07_20m.mp4", "start" : "05:30"},\
"overlay" : { \
    "benchmark" : { \
...
"overlay" : { \
    "text" : ["'Rainbow Six\: Siege'",\
              scriptedvided.r6sText('1920x1080, low settings, 100% render scale',57, 46 ), \
              scriptedvided.r6sText('1280x720, low settings, 100% render scale', 110 , 81 ),\
              scriptedvided.r6sText('1920x1080, low settings, 50% render scale', 85 , 66 ),\
              scriptedvided.r6sText('1280x720, low settings, 50% render scale', 146  ,  102)]\
}, \
})
