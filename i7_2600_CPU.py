...
"overlay" : { \
    "text" : ["'Fortnite'",\
              ...
              scriptedvided.r6sText('1280x720, performance mode, inSpectre',  , )\
]}, \
"video" : ""\
})
...
"overlay" : { \
    "text" : ["'Rainbow Six\: Siege'",\
              scriptedvided.r6sText('1280x720, 50% scale, low settings',  , )\
              scriptedvided.r6sText('1280x720, 50% scale, low settings, inSpectre',  , )\
]}, \
},
})
...
"overlay" : { \
    "text" : ["'Counter-Strike 2'",\
              ...
              scriptedvided.r6sText('1280x720, low settings, inSpectre',  , )\
]},\
})
...
configs["episodes"].append(\
{ "title": "cs2, r6s and Final warning",\
"audio" : {"timestamps" : (scriptedvided.nextTS(configs), "" ), "volume" : 0.999, "padAudio" : 0.05 },\
"video" : {"file" : ""},\
"isChapter" : False,\
"overlay" : { \
