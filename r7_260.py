...
"overlay" : { \
    "text" : ["'Apex Legends'",\
              "'1080p, low setings - Average\: 57fps, 1\\\% lows\: 35fps'",\
              "'720p, low setings - Average\: 75fps, 1\\\% lows\: 50fps'"]\
}, \
})
...
"overlay" : { \
    "text" : ["'Splitgate'",\
              "'1080p, low setings - Average\: 83fps, 1\\\% lows\: 38fps'",\
              "'720p, low setings - Average\: 119fps, 1\\\% lows\: 56fps'"]\
}, \
})
