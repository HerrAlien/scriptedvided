...
scriptedvided.makeVideoForEpisode([x for x in configs["episodes"] if x["title"] == "pricing OLX"][0], configs)
scriptedvided.makeVideoForEpisode([x for x in configs["episodes"] if x["title"] == "pricing new"][0], configs)
scriptedvided.makeVideoForEpisode([x for x in configs["episodes"] if x["title"] == "GDDR5 vs DDR4"][0], configs)
