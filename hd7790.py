...
"overlay" : { \
    "text" : ["'Rainbow Six\: Siege'",\
              scriptedvided.r6sText('1920x1080, 100% scale, low settings' , , ),\
              scriptedvided.r6sText('1280x720, 100% scale, low settings' , , ),\
              scriptedvided.r6sText('1920x1080, 50% scale, low settings' , , ),\
