...
"video" : {"file": "gt730_ad.mkv", "rotation" : 180},\
})
...
"audio" : {"timestamps" : ("00:48" , "01:17.5"), "volume" : 0.999 },\
"video" : {"file" : "card_and_issues_on_it.mp4", "start" : "01:10"}\
})

configs["episodes"].append(\
{ "title": "Schematic with inductor beads",\
"isChapter" : False, \
"audio" : {"timestamps" : ("01:17.5", "01:41"), "volume" : 0.999 },\
"video" : {"file" : "-- some schematic --", "start" : "01:10"}\
})
...
"video" : {"file" : " --- slide with measurements --- ", "start" : "00:40"}\
})

configs["episodes"].append(\
{ "title": "Fixes for the back of the GPU area",\
"audio" : {"timestamps" : ( "02:28", "03:01"), "volume" : 0.999 },\
"video" : {"file" : " --- inductor and decoupling cap --- ", "start" : "00:40"}\
})
...
"video" : {"file" : "--- both pad forming and caps from gtx 960  --- ", "start" : "00:15"}\
})
...
"video" : {"file" : "scraping_traces_lane11.mp4", "start" : "01:40"}\
})

configs["episodes"].append(\
{ "title": "Check the fixed PCIE lanes",\
"audio" : {"timestamps" : ("05:32", "05:47.8"), "volume" : 0.999 },\
"video" : {"file" : "----- shorts between pcie fingers -----", "start" : "01:40"}\
})
...
"video" : {"file" : "Fermi_GT730_GPU_Z.mkv",}\
})
